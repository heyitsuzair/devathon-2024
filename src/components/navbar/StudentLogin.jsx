...
import { StudentLoginSchema } from "@/validationSchema";
...
const StudentLogin = ({
  ...
  const onSubmit = async (values, { resetForm }) => {
    const { data, success, payload } = await loginStudent(values);
  ...
  return (
    <div>
      <TextXl text="Student Login" classes="font-semibold my-5" />
